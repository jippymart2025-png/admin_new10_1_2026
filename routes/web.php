...
Route::middleware(['permission:master-products,master-products'])->group(function () {
    Route::get('/master-products', [App\Http\Controllers\MasterProductController::class, 'index'])->name('master-products.index');
    Route::get('/master-products/data', [App\Http\Controllers\MasterProductController::class, 'data'])->name('master-products.data');
    Route::get('/master-products/options', [App\Http\Controllers\MasterProductController::class, 'options'])->name('master-products.options');
});
Route::middleware(['permission:master-products,master-products.create'])->group(function () {
    Route::get('/master-products/create', [App\Http\Controllers\MasterProductController::class, 'create'])->name('master-products.create');
    Route::post('/master-products', [App\Http\Controllers\MasterProductController::class, 'store'])->name('master-products.store');
});
Route::middleware(['permission:master-products,master-products.edit'])->group(function () {
    Route::get('/master-products/edit/{id}', [App\Http\Controllers\MasterProductController::class, 'edit'])->name('master-products.edit');
    Route::put('/master-products/{id}', [App\Http\Controllers\MasterProductController::class, 'update'])->name('master-products.update');
    Route::post('/master-products/{id}/toggle-publish', [App\Http\Controllers\MasterProductController::class, 'togglePublish'])->name('master-products.togglePublish');
    Route::post('/master-products/{id}/toggle-available', [App\Http\Controllers\MasterProductController::class, 'toggleAvailable'])->name('master-products.toggleAvailable');
    Route::patch('/master-products/inline-update-suggested-price/{id}', [App\Http\Controllers\MasterProductController::class, 'inlineUpdateSuggestedPrice'])->name('master-products.inlineUpdateSuggestedPrice');
});
Route::middleware(['permission:master-products,master-products.delete'])->group(function () {
    Route::delete('/master-products/{id}', [App\Http\Controllers\MasterProductController::class, 'destroy'])->name('master-products.delete');
    Route::post('/master-products/delete-multiple', [App\Http\Controllers\MasterProductController::class, 'deleteMultiple'])->name('master-products.delete-multiple');
});
...
Route::middleware(['permission:promotions,promotions'])->group(function () {
    ...
    Route::post('/promotions/togglePromo/{id}', [App\Http\Controllers\PromotionController::class, 'togglePromotion'])->name('promotions.togglePromo');
...
Route::middleware(['permission:promotions,promotions.create'])->group(function () {
    ...
    Route::post('/promotions/bulk-store', [App\Http\Controllers\PromotionController::class, 'bulkStore'])->name('promotions.bulkStore');
});
...
// API route for getting single notification (used in create/edit view)
Route::get('api/dynamic-notification/{id}', [App\Http\Controllers\DynamicNotificationController::class, 'show'])->name('api.dynamic-notification.show');
...
Route::get('/settlements/vendor/{vendorId}/orders', [SettlementReportController::class, 'vendorOrders']);
Route::post('/settlements/vendor/{vendorId}/save', [SettlementReportController::class, 'saveVendorSettlement']);
Route::get('/settlements/filter-weeks', [SettlementReportController::class, 'filterWeeks']);
Route::get('/settlements/vendors-by-date', [SettlementReportController::class, 'getVendorsByDateRange']);
Route::get('/settlements/summary-by-date', [SettlementReportController::class, 'getSummaryByDateRange']);
Route::get('/settlements/export', [SettlementReportController::class, 'exportSettlement']);
Route::post('/settlements/week/save', [SettlementReportController::class, 'saveSettlementWeek']);
Route::get('/merchantSettlement/view', [App\Http\Controllers\SettlementReportController::class, 'merchantSettlementView'])->name('mViewSettlement.reports');
Route::get('/driverSettlements', [App\Http\Controllers\SettlementReportController::class, 'driverIndex'])->name('driverSettlement.reports');
Route::get('/settlements/drivers-by-date', [SettlementReportController::class, 'getDriversByDateRange']);
Route::get('/settlements/driver-summary-by-date', [SettlementReportController::class, 'getDriverSummaryByDateRange']);
Route::get('/settlements/week/{weekId}/drivers', [SettlementReportController::class, 'weekDrivers']);
Route::get('/settlements/week/{weekId}/driver-summary', [SettlementReportController::class, 'weekDriverSummary']);
Route::get('/settlements/driver/{driverId}/orders', [SettlementReportController::class, 'driverOrders']);
...
// Subscription plans routes - separated by permissions
Route::middleware(['permission:subscription-plans,subscription-plans'])->group(function () {
    Route::get('/subscription-plans', [App\Http\Controllers\SubscriptionPlanController::class, 'index'])->name('subscription-plans.index');
...
// Delete subscription plan - allow base permission or specific delete permission
...
Route::middleware(['permission:restaurants,restaurants.edit'])->group(function () {
    ...
    Route::post('/restaurants/{id}/toggle-gst', [App\Http\Controllers\RestaurantController::class, 'toggleRestaurantGstStatus'])->name('restaurants.toggle-gst');
    Route::post('/vendors/{vendor}/apply-subscription-commission', [App\Http\Controllers\RestaurantController::class, 'applySubscriptionCommission'])->name('vendors.applySubscriptionCommission');
